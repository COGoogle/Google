...
function generateInvoice() {
  ...
  var orderInfo = {
    ...
    items: [
      { name: 'Wallet Protect Patch API', description: 'Advanced security API with documentation', price: 6894.00 },
      { name: 'Google Map API', description: 'Premium mapping service access', price: 31891.00 }
    ],
    subtotal: 38785.00,
    gst: 6981.30,
    totalAmount: 45766.30,
    developerDiscount: 1870.00,
    otherDiscount: 800.00,
    finalAmount: 43096.30
  };
